...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataSamples', type=int, default=100000, help='Number Of Samples Used from the CSV') 

    parser.add_argument('--numberOfKernels', type=float, default=32)
    parser.add_argument('--printEvery', type=int, default=100, help='Trainning Logging Frequency in # of batches') 
